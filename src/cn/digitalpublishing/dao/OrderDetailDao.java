...
public class OrderDetailDao extends CommonDao<OOrderDetail, String>{
	...
	public List<OOrderDetail> getPagingList(Map<String,Object> condition,String sort,Integer pageCount,Integer page)throws Exception{
		...
		String hql=" from OOrderDetail o ";
		Map<String,Object> t=this.getWhere(condition);
		String property="id,odetailNum,createdby,createdon,updatedby,updatedon,name,author,publisher,pubid,ip,listPrice,quantity,settledPrice,status";
		String field="o.id,o.odetailNum,o.createdby,o.createdon,o.updatedby,o.updatedon,o.name,o.author,o.publisher,o.pubid,o.ip,o.listPrice,o.quantity,o.settledPrice,o.status";
		try{
