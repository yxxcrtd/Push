...
public class BooksDao extends CommonDao<Books, String> {
	...
	private Map<String,Object> getWhere(Map<String,Object> map){
		...
		if(CollectionsUtil.exist(map, "isbn")&&!"".equals(map.get("isbn"))){
			if(flag==0){
				whereString+=" where lower(b.isbn) = ?";
				flag=1;
			}else{
				whereString+=" and lower(b.isbn) = ?";
			}
			condition.add("%"+map.get("isbn").toString().trim().toLowerCase()+"%");
		}
		
		if(CollectionsUtil.exist(map, "aisbn")&&!"".equals(map.get("aisbn"))){
			if(flag==0){
				whereString+=" where lower(b.isbn) = ?";
				flag=1;
			}else{
			...
			condition.add(map.get("aisbn").toString().trim());
		}
	...
	public List<Books> getList(Map<String,Object> condition,String sort)throws Exception{
		...
		String hql=" from Books b ";
		Map<String,Object> t=this.getWhere(condition);
		String property="id,orderNo,title,author,publishDate,isbn,price,onPrice,offPrice,publisher,location,edition,page,frame,format,sheet,cover,url,cunZai";
		String field="b.id,b.orderNo,b.title,b.author,b.publishDate,b.isbn,b.price,b.onPrice,b.offPrice,b.publisher,b.location,b.edition,b.page,b.frame,b.format,b.sheet,b.cover,b.url,b.cunZai";
		try{
