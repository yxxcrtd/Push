	 	...
	 	function getTargetXml(id){
		 	var arr_select = getselecedVal();
				if(arr_select.length<=0){
					...
					if(window.confirm("<ingenta-tag:LanguageTag sessionKey='lang' key='Pages.PushOrder.create.xml'/>")){
						document.getElementById("form").action="targetXml";
						document.getElementById("id").value=id;
						document.getElementById("page").value=document.getElementById("txtPage").value-1;
						document.getElementById("form").submit();
					}
...
<div class="bodyDiv bodyNew" style="position:relative;">
	...
	<table width="95%" border="0" cellpadding="0" cellspacing="1" class="tab02">
       <tr>
         ...
         <th width="14%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.book.Name"/>:&nbsp;</th>
       	 <td width="18%">
         ...
         <tr>
         <th width="14%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.book.isbn"/>:&nbsp;</th>
          <td width="18%">
         	<form:input path="isbn" cssStyle="width:98%" id="fileCode"/>
         </td>
         
         <th width="8%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.book.xml"/>:&nbsp;</th>
         <td width="18%">
...
<div class="bodyBg">
	<div class="module">
	  ...
	  <div style="margin:5px 0px;">
		   ...
		   <input type="button" value="<ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.createXml.pl"/>" class="devil_button" onclick="getUserXml()"/>
		   <input type="button" value="<ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.createXml.pl.Target"/>" class="devil_button" onclick="getTargetXml()"/>
     	...
     	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="devil_table">
     		...
     		<tr>
		        ...
		        <th width="12%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.book.Name"/></th>
		        <th width="12%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.book.isbn"/></th>
		        <th width="10%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.book.author"/></th>
		        <th width="8%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.book.fen.lei"/></th>
		        ...
		        <th width="10%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.chuban.date"/></th>
		        <th width="8%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.book.xml"/></th>
		        <th width="28%" align="center"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.UserDate.user.operation"/></th>
		    </tr>
		    </thead>
		    <tbody>
