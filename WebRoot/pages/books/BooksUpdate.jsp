...
<div class="bodyDiv" >
    ...
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="tab02">
     ...
     <%--  <tr>
      ...
      <tr>
        <th width="30%"><ingenta-tag:LanguageTag sessionKey="lang" key="Pages.PushOrder.orderDetail.beizhu"/>：</th>
        <td width="60%" align="left">
        	<form:textarea path="obj.remark" id="remark" cssStyle="width:60%"/>
        </td>
      </tr>
    </table>
    </div>
